...
C {lab_pin.sym} 180 -1060 0 0 {name=p1 sig_type=std_logic lab=a}
C {lab_pin.sym} 180 -1020 0 0 {name=p2 sig_type=std_logic lab=b}
C {lab_pin.sym} 320 -1040 0 1 {name=p5 sig_type=std_logic lab=NMIN}
C {xschem_designs/NMIN.sym} 230 -570 0 0 {name=x1}
C {xschem_designs/NMAX.sym} 240 -840 0 0 {name=x2}
C {lab_pin.sym} 180 -960 0 0 {name=p18 sig_type=std_logic lab=a}
C {lab_pin.sym} 180 -920 0 0 {name=p19 sig_type=std_logic lab=b}
C {xschem_designs/STI.sym} 200 -590 1 0 {name=x3}
C {lab_pin.sym} 180 -850 0 0 {name=p28 sig_type=std_logic lab=a}
C {lab_pin.sym} 1020 -660 0 1 {name=p39 sig_type=std_logic lab=Q}
...
C {lab_pin.sym} 1020 -520 0 1 {name=p3 sig_type=std_logic lab=nQ}
C {lab_pin.sym} 200 -660 0 0 {name=p4 sig_type=std_logic lab=D}
C {lab_pin.sym} 140 -390 0 0 {name=p6 sig_type=std_logic lab=clk}
